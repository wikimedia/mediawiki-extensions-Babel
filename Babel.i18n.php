...
$messages['azb'] = array(
	...
	'babel-autocreate-text-levels' => 'بو بولمه‌ده کی کوللانیجیلار $1 سئویيئدئ $2 دیلینی بیلدیکلئرینی بئلیرتیيور.',
	'babel-autocreate-text-main' => 'بو بولمه‌داکی ایستیفاده‌چیلر $1 دیلینی بیلدیک‌لرینی ایفاده ائدر .',
	...
	'babel-2-n' => 'بو ایشلدن [[$1|اورتاجا]] سئویه‌ده [[$2|تورکجه]] بیلیر.',
