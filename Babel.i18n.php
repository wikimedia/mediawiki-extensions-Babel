...
$messages['mk'] = array(
	...
	'babel-url' => 'Project:Вавилон',
	'babel-footer-url' => ':Category:Babel - Корисници по јазик',
...
$messages['ml'] = array(
	...
	'babel-1' => 'ഈ ഉപയോക്താവിനു [[$2|$3]] എന്ന ഭാഷയിൽ [[$1|അടിസ്ഥാനജ്ഞാനം മാത്രമേ ഉള്ളൂ]].',
	'babel-2' => 'ഈ ഉപയോക്താവിനു [[$2|$3]] എന്ന ഭാഷയിൽ [[$1|സാമാന്യ]] ജ്ഞാനമുണ്ട്.',
	'babel-3' => 'ഈ ഉപയോക്താവിനു [[$2|$3]] എന്ന ഭാഷയിൽ [[$1|ഉന്നത]] ജ്ഞാനമുണ്ട്.',
	'babel-4' => 'ഈ ഉപയോക്താവ് [[$2|$3]] എന്ന ഭാഷയിൽ പ്രസ്തുത ഭാഷ [[$1|മാതൃഭാഷയായിട്ടുള്ളവർക്കുള്ള]] ജ്ഞാനമുണ്ട്.',
	...
	'babel-0-n' => 'ഈ ഉപയോക്താവിനു [[$2|മലയാള ഭാഷയിൽ]] ഒട്ടും അറിവ് [[$1|ഇല്ല]] (അല്ലെങ്കിൽ മലയാളം വളരെ ബുദ്ധിമുട്ടിയാണു മനസ്സിലാക്കുന്നത്).',
	'babel-1-n' => 'ഈ ഉപയോക്താവിനു [[$2|മലയാള ഭാഷയിൽ]] [[$1|അടിസ്ഥാന]] ജ്ഞാനമുണ്ട്.',
	'babel-2-n' => 'ഈ ഉപയോക്താവിനു [[$2|മലയാള ഭാഷയിൽ]] [[$1|സാമാന്യം]] ജ്ഞാനമുണ്ട്.',
	'babel-3-n' => 'ഈ ഉപയോക്താവിനു [[$2|മലയാള ഭാഷയിൽ]] [[$1|ഉയർന്ന]] ജ്ഞാനമുണ്ട്.',
	'babel-4-n' => 'ഈ ഉപയോക്താവിനു [[$2|മലയാള ഭാഷ]] [[$1|മാതൃഭാഷയായിട്ടുപയോഗിക്കുന്നവർക്കു]] സമാനമായുള്ള ജ്ഞാനമുണ്ട്.',
	'babel-5-n' => 'ഈ ഉപയോക്താവിനു [[$2|മലയാള ഭാഷയിൽ]] [[$1|പണ്ഡിത]] സമാന ജ്ഞാനമുണ്ട്.',
...
$messages['or'] = array(
	...
	'babel-0' => 'ଏହି ଇଉଜର  [[$2|$3]] ଜାଣନ୍ତି [[$1|ନାହିଁ]] (କି ଅଳ୍ପ ଅଳ୍ପ ବୁଝନ୍ତି ନାହି) ।',
	'babel-1' => 'ଏହି ଇଉଜରଙ୍କୁ [[$2|$3]] ଭାଷା [[$1|ଅଳପ]] ଜଣାଅଛି ।',
	'babel-2' => 'ଏହି ଇଉଜର [[$2|$3]] ଭାଷା [[$1|ଚଳିବା ଭଳି]] ଜାଣନ୍ତି ।',
	'babel-3' => 'ଏହି ଇଉଜର [[$2|$3]] ଭାଷା [[$1|ଭଲକରି]] ଜାଣନ୍ତି ।',
	'babel-4' => 'ଏହି ଇଉଜର [[$2|$3]] ଭାଷା  ତାହାର [[$1|ମୁଳ ଲୋକଙ୍କ]] ଭଳି ଜାଣନ୍ତି ।',
	'babel-N' => 'ଏହି ଇଉଜରଙ୍କ [[$1|ନିଜ ଭାଷା]] ହେଲା [[$2|$3]] ।',
	'babel-0-n' => 'ଏହି ଇଉଜର [[$2|ଇଁରାଜି]] ଜମାରୁ [[$1|ବୁଝନ୍ତି ନାହିଁ]] ବା ଟିକେ ଟିକେ ବୁଝିପାରନ୍ତି ।',
	'babel-1-n' => 'ଏହି ଇଉଜରଙ୍କୁ [[$2|ଇଁରାଜି]] ଭାଷା [[$1|ଅଳପ]] ଜଣାଅଛି ।',
	'babel-2-n' => 'ଏହି ଇଉଜର [[$2|ଇଁରାଜି]] ଭାଷା [[$1|ଚଳିବା ଭଳି]] ଜାଣନ୍ତି ।',
	'babel-3-n' => 'ଏହି ଇଉଜର [[$2|ଇଁରାଜି]] ଭାଷା [[$1|ଭଲକରି]] ଜାଣନ୍ତି ।',
	'babel-4-n' => 'ଏହି ଇଉଜର [[$2|ଇଁରାଜି]] ଭାଷା  ତାହାର [[$1|ମୁଳ ଲୋକଙ୍କ]] ଭଳି ଜାଣନ୍ତି ।',
...
$messages['sr-ec'] = array(
	...
	'babel-0' => '{{GENDER:$4|Овај корисник|Ова корисница|Овај члан}} [[$1|не]] зна [[$2|$3]] језик (или га разуме са знатним потешкоћама).',
	'babel-1' => '{{GENDER:$4|Овај корисник|Ова корисница|Овај члан}} говори [[$2|$3]] језик [[$1|почетнички]].',
	'babel-2' => '{{GENDER:$4|Овај корисник|Ова корисница|Овај члан}} [[$1|средње]] познаје [[$2|$3]] језик.',
	'babel-3' => '{{GENDER:$4|Овај корисник|Ова корисница|Овај члан}} [[$1|доста добро]] познаје [[$2|$3]] језик.',
	'babel-4' => '{{GENDER:$4|Овај корисник|Ова корисница|Овај члан}} [[$1|течно]] говори [[$2|$3]] језик.',
	'babel-5' => '{{GENDER:$4|Овај корисник|Ова корисница|Овај члан}} зна [[$2|$3]] језик на [[$1|професионалном]] нивоу.',
	'babel-N' => '[[$1|Матерњи језик]] {{GENDER:$4|овог корисника|ове кориснице|овог члана}} је [[$2|$3]] језик.',
	'babel-0-n' => '{{GENDER:$4|Овај корисник|Ова корисница|Овај члан}} [[$1|не]] зна [[$2|српски језик]] (или га разуме са знатним потешкоћама).',
	'babel-1-n' => '{{GENDER:$4|Овај корисник|Ова корисница|Овај члан}} има [[$1|основно]] познавање [[$2|српског језика]].',
	'babel-2-n' => '{{GENDER:$4|Овај корисник|Ова корисница|Овај члан}} [[$1|средње]] познаје [[$2|српски језик]].',
	'babel-3-n' => '{{GENDER:$4|Овај корисник|Ова корисница|Овај члан}} [[$1|доста добро]] познаје [[$2|српски језик]].',
	'babel-4-n' => '{{GENDER:$4|Овај корисник|Ова корисница|Овај члан}} [[$1|течно]] говори [[$2|српски језик]].',
	'babel-5-n' => '{{GENDER:$4|Овај корисник|Ова корисница|Овај члан}} зна [[$2|српски језик]] на [[$1|професионалном]] нивоу.',
