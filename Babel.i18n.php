...
$messages['fr'] = array(
	...
	'babel-url'            => 'Project:Babel',
	'babel-directionality' => 'ltr',
	'babel-0'              => 'Cette utilisateur n’a [[$1|aucune]] connaissance en [[$2|$3]] (ou comprend avec de grandes difficultés).',
	'babel-1'              => 'Cet utilisateur peut contribuer avec un niveau [[$1|élémentaire]] de [[$2|$3]].',
	...
	'babel-4'              => "C'est utilisateur a une connaissance proche de la [[$1|langue maternelle]] en [[$2|$3]].",
	'babel-5'              => 'Ce contributeur a une connaissance [[$1|professionnelle]] du [[$2|français]].',
	'babel-N'              => 'Cet utilisateur dispose d’une compréhension comme [[$1|langue maternelle]] en [[$2|$3]].',
	'babel-0-n'            => 'Cet utilisateur n‘a [[$1|aucune]] connaissance en [[$2|anglais]] (ou le comprend avec de grandes difficultés).',
	'babel-1-n'            => 'Cet utilisateur dispose de connaissances [[$1|de base]] en [[$2|anglais]].',
	'babel-2-n'            => "Cet utilisateur dispose d'un [[$1|niveau intermédiaire]] de connaissance en [[$2|anglais]].",
	'babel-3-n'            => 'Cet utilisateur dispose de connaissances [[$1|avancées]] en [[$2|anglais]].',
	'babel-4-n'            => 'Cet utilisateur dispose de connaissances proches de la [[$1|langue maternelle]] en [[$2|anglais]].',
	'babel-5-n'            => "Cet utilisateur dispose d'un niveau de connaissances professionel de l'[[$2|anglais]].",
	'babel-N-n'            => "Cet utilisateur a pour [[$1|langue maternelle]] l'[[$2|anglais]]",
);
...
$messages['kk-cyrl'] = array(
	...
	'babel-4'              => 'Бұл қатысушы [[$2|$3]] [[$1|ана тілі шамасы деңгейде]] меңгереді.',
...
$messages['nl'] = array(
	...
	'babel-5'    => 'Deze gebruiker heeft een [[$1|professionele]] kennis van het [[$2|Nederlands]].',
	'babel-N'    => 'Deze gebruiker beheerst het [[$2|$3]] op [[$1|moedertaal niveau]].',
	...
	'babel-N-n'  => 'Voor deze gebruiker is het [[&2|Nederlands]] de [[&1|moedertaal]].',
);
...
$messages['no'] = array(
	...
	'babel-1'              => 'Denne brukeren kan [[$1|litt]] [[$2|{{lc:$3}}]].',
...
$messages['pl'] = array(
	...
	'babel-directionality' => 'ltr',
	'babel-0'              => 'Ta osoba [[$1|nie rozumie]] [[$2|języka polskiego]] (albo ma z nim olbrzymie trudności).',
	'babel-1'              => 'Ten użytkownik posługuje się [[$2|językiem polskim]] na poziomie [[$1|podstawowym]].',
	'babel-2'              => 'Ten użytkownik posługuje się [[$2|językiem polskim]] na poziomie [[$1|średnio zaawansowanym]].',
	'babel-3'              => 'Ten użytkownik posługuje się [[$2|językiem polskim]] na poziomie [[$1|zaawansowanym]].',
	'babel-4'              => 'Ten użytkownik posługuje się [[$2|językiem polskim]] prawie jak [[$1|językiem ojczystym]].',
	'babel-5'              => 'Ten użytkownik posługuje się [[$2|językiem polskim]] na równi z [[$1|językiem ojczystym]].',
	'babel-N'              => '[[$2|Polski]] jest [[$1|językiem ojczystym]] tego użytkownika.',
);
...
$messages['sv'] = array(
	...
	'babel-url'            => 'Project:Babel',
	'babel-directionality' => 'ltr',
	'babel-0'              => 'Den här användaren kan [[$1|inte]] förstå [[$2|$3]] (eller förstår det med en betydande svårighet).',
	'babel-1'              => 'Den här användaren har [[$1|grundläggande]] kunskaper av [[$2|$3]].',
	'babel-2'              => 'Den här användaren kan [[$2|$3]] på [[$1|medelnivå]].',
	'babel-3'              => 'Den här användaren har [[$1|avancerade]] kunskaper av [[$2|$3]].',
	'babel-4'              => 'Den här användaren kan [[$2|$3]] [[$1|nästan på modersmålsnivå]].',
	'babel-5'              => 'Den här användaren har [[$1|proffisionella]] kunskaper av [[$2|$3]].',
