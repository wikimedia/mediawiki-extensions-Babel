...
$messages['pnt'] = array(
	...
	'babel-desc' => 'Προσθέτει τη <tt>#babel</tt> λειτουργία για να επιτρέψει την αυτόματη γενικοποίηση ενός πίνακα βαβέλ με τη δυντότητα να περιλαμβάνει διάφορα πρότυπα',
	'babel-url' => 'Project:Βαβέλ',
	'babel-autocreate-abort' => 'Το όνομα χρήστη που έδωσες χρησιμοποιείται για τη κατηγορία αυτοδημιουργίας Βαβέλ και δεν μπορεί να κατοχυρωθεί.',
	'babel-autocreate-reason' => 'Αυτόματη δημιουργία τς σελίδας κατηγορίας Βαβέλ.',
	'babel-autocreate-text-levels' => "Οι χρήστες ση κατηγορία ατή λέν' πως μιλούν τη γλώσσα $2 σε επίπεδο $1.",
	'babel-autocreate-text-main' => "Οι χρήστες ση κατηγορίαν ατή γνωρίζ'ν τη γλώσσα σε επίπεδο $1.",
